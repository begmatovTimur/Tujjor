        ...
        <div>
            ...
            <div id='loginForm'>
                ...
                <div className="form">
                    ...
                    />
                    <input className={'form-control'} value={loginReducer.password}
                           onChange={(e) => props.changePassword(e.target.value)}
                           style={{width: "100%", marginTop: "20px"}} type={"password"} id="outlined-basic"
                           label="Enter your password" variant="outlined" placeholder={"Type a password..."}/>
                    <div className={'d-flex justify-content-between'}>
                        <label className={'my-3'}>
                            <input value={loginReducer.remember} onChange={(e) => props.rememberMe(e.target.checked)}
                                   style={{width: "20px", height: "20px"}} type="checkbox"/> Remember me
                        </label>
                        <Button onClick={loginfunction}
                                style={{backgroundColor: "#65b965", marginTop: 20, width: "30%"}} variant="contained">To
                            come in <i
