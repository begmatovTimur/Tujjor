            ...
            <div>
              {JsxData !== "" && inpData !== "" ? (
                ...
                <div style={{ width: "100%" }}>
                  {JsxData}
                  <button
                    style={{ width: "20%", margin: "15px 0px 5px 0px" }}
                    className={"btn btn-success"}
                    onClick={functionforSaveBtn}
                  >
                    Save
      ...
      >
        <Box sx={style2}>
          ...
          >
            ...
            >
              <b>Haqiqatan ham ushbu modalni yopmoqchimisiz? Saqlanmagan barcha o'zgarishlar yo'qoladi.</b>
            </div>
            <div
            ...
            >
              ...
              <button
                onClick={() => setMiniModal(false) & closeFunction() & functionforSaveBtn()}
                className={"btn btn-success"}
              >
                Ha
              </button>
